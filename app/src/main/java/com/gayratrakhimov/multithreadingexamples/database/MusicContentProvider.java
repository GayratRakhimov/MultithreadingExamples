...
public class MusicContentProvider extends ContentProvider {
    ...
    private static final String TAG = MusicContentProvider.class.getSimpleName();
    private static final String AUTORITY = "com.gayratrakhimov.multithreadingexamples.musicprovider";
    ...
    static {
        URI_MATCHER.addURI(AUTORITY, TABLE_ALBUM, ALBUM_TABLE_CODE);
        URI_MATCHER.addURI(AUTORITY, TABLE_ALBUM + "/*", ALBUM_ROW_CODE);
    }
    ...
    public String getType(Uri uri) {
        switch (URI_MATCHER.match(uri)) {
            case ALBUM_TABLE_CODE:
                return "vnd.android.cursor.dir/" + AUTORITY + "." + TABLE_ALBUM;
            case ALBUM_ROW_CODE:
                return "vnd.android.cursor.item/" + AUTORITY + "." + TABLE_ALBUM;
            default:
